...
import ModalShareCoupon from './ModalShareCoupon'
...
function Coupons() {
  const modalShareCoupon = useModal()
  ...
  return (
    <>
      ...
      {modalShareCoupon.isOpen && (
        <ModalShareCoupon coupon={coupon} close={modalShareCoupon.closeModal} />
      )}
    </>
  )
}
